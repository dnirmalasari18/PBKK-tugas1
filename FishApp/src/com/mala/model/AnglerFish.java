...
public class AnglerFish implements Fish {
	...
	public AnglerFish() {
		this.fishScientificName="Lophiiformes";
	}
	
	public AnglerFish(String fishCode, int fishMass, int fishLength, String fishGender) {
		super();
	...
	public void fishType() {
		System.out.println("This is an angler fish");
	}
}
